...
public class AdminGoodsDAOImpl  implements AdminGoodsDAO{
	...
	public int insertNewGoods(Map newGoodsMap) throws DataAccessException {
		...
		return Integer.parseInt((String)newGoodsMap.get("goods_id")); //int 값으로 받기 위해서 타입변환
	}
	...
	//추가 AdminGoodsDAO.java도 고치는거 주의
	@Override
    public int selectTotArticles(Map condMap) {
        return sqlSession.selectOne("mapper.admin.goods.selectTotArticles", condMap);
    } 
