...
function fn_order_each_goods(goods_id,goods_title,goods_sales_price,fileName){
	var _isLogOn=document.getElementById("isLogOn");  //hidden태그에서 로그인 여부에 관한 값을 가져온다.
	var isLogOn=_isLogOn.value;
	
	 if(isLogOn=="false" || isLogOn=='' ){ //로그인이 안 되어 있으면 alert창 띄워주고 loginForm.jsp로 redirect
		...
		var formObj=document.createElement("form"); //form 태그 동적으로 생성 
		var i_goods_id = document.createElement("input");   // <input>태그 동적 생성
    var i_goods_title = document.createElement("input");
    var i_goods_sales_price=document.createElement("input");
    var i_fileName=document.createElement("input");
    var i_order_goods_qty=document.createElement("input");
    
    i_goods_id.name="goods_id";       //input 태그 속성 설정 
    i_goods_title.name="goods_title";
    i_goods_sales_price.name="goods_sales_price";
    i_fileName.name="goods_fileName";
    i_order_goods_qty.name="order_goods_qty";
    
    i_goods_id.value=goods_id;   //함수 인자로 받아온 값들 value 값으로 저장해줌
